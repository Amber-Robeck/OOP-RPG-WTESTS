...
class Game {
    ...
    battle() {
        if (this.isPlayerTurn) {
                ...
                .then(({ action }) => {
                    ...
                    switch (action) {
                        ...
                        case 'Attack':
                            ...
                            console.log(`❎ You attacked the ${this.currentEnemy.name} dealing ${damage} damage.`);
            ...
            console.log(`❌ You were attacked by the ${this.currentEnemy.name} who dealt ${damage} damage.`);
